const { Wavelet, Contract, TAG_TRANSFER, JSBI, Buffer } = require(".."); //window["wavelet-client"];
...
(async () => {
  ...
  const contractId = await client.deployContract(wallet, toArrayBuffer(contractCode), JSBI.BigInt(100000));
  console.log("res", contractId);
